    ...
    <Modal.Body>
      <Form>
        ...
        <SliderWithTooltip 
          ...
          tooltip="Als dit niet je eerste MyContext installatie is moet je een identity file uploaden. Daarmee zorgen we ervoor dat de gegevens tussen je verschillende apparaten worden gesynchroniseerd." 
